...
echo "${CYAN_TEXT}${BOLD_TEXT}             Arcade Hero Building Blocks Artifact Registry IV          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}-----------------------------------------------------------------------${RESET_FORMAT}"
echo ""
...
echo -e "${BLUE_TEXT}${BOLD_TEXT}---> Creating a new Docker repository in the '${REGION}' region...${RESET_FORMAT}"
gcloud artifacts repositories create container-registry \
  --repository-format=docker \
  --location=$REGION \
  --description="Docker registry with cleanup policy"

echo -e "${BLUE_TEXT}${BOLD_TEXT}---> Creating a Python repository in '${REGION}' region...${RESET_FORMAT}"
