...
echo "${CYAN_TEXT}${BOLD_TEXT}        Create a Virtual Machine          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}-----------------------------------${RESET_FORMAT}"
echo ""
...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}---> Creating 'gcelab2' Instance...${RESET_FORMAT}"
echo
...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}---> Installing Nginx on 'gcelab'...${RESET_FORMAT}"
