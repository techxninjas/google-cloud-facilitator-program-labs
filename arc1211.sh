...
echo "${CYAN_TEXT}${BOLD_TEXT}           Arcade Hero: Building Blocks Artifact Registry V          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}-----------------------------------------------------------------------${RESET_FORMAT}"
echo ""
...
echo -e "${BLUE_TEXT}${BOLD_TEXT}Enabling the Artifact Registry API...${RESET_FORMAT}"
gcloud services enable artifactregistry.googleapis.com
 
echo -e "${BLUE_TEXT}${BOLD_TEXT}Creating a Docker repository named 'container-registry' in the $REGION region...${RESET_FORMAT}"
gcloud artifacts repositories create container-registry \
  --repository-format=docker \
  --location=$REGION \
  --description="Docker registry with cleanup policy"
 
echo -e "${BLUE_TEXT}${BOLD_TEXT}Creating an APT repository named 'apt-registry' $REGION region...${RESET_FORMAT}"
