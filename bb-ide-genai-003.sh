...
echo "${CYAN_TEXT}${BOLD_TEXT}    Build an application to send Chat Prompts using the Gemini model  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}-----------------------------------------------------------------------${RESET_FORMAT}"
echo ""
...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}---> Generating SendChatwithoutStream.py...${RESET_FORMAT}"
...
echo "${BLUE_TEXT}${BOLD_TEXT}---> Executing SendChatwithoutStream.py...${RESET_FORMAT}"
/usr/bin/python3 /home/student/SendChatwithoutStream.py
sleep 5

echo
echo "${BLUE_TEXT}${BOLD_TEXT}---> Generating SendChatwithStream.py...${RESET_FORMAT}"
...
echo "${BLUE_TEXT}${BOLD_TEXT}---> Executing SendChatwithStream.py...${RESET_FORMAT}"
