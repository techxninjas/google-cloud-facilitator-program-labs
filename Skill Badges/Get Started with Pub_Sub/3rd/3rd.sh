...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}Creating a Pub/Sub topic with JSON message encoding...${RESET_FORMAT}"
echo ""
...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Creating Node.js function code that processes Pub/Sub messages...${RESET_FORMAT}"
echo ""
...
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}Creating package.json with required dependencies...${RESET_FORMAT}"
echo ""
...
echo
echo "${RED_TEXT}${BOLD_TEXT}Deploying the Cloud Function with Pub/Sub trigger.${RESET_FORMAT}"
echo ""
deploy_function() {
